...
options.cloneLimit = true; //if you want more then 300 clones, this does that, changing it to true enables the 300 limit.
options.miscLimits = true; //other limits that scratch has, false means disable these, like sound pitch and stuff.
