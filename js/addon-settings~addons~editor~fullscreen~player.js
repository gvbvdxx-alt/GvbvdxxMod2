...
var isScratchDesktop = __webpack_require__(139);
...
if (Object(isScratchDesktop["a" /* isScratchDesktop */])()) tw_disable_cloud_variables_manifest_entry_manifest.unsupported = true;
...
// EXTERNAL MODULE: ./src/addons/generated/addon-manifests.js + 72 modules
var addon_manifests = __webpack_require__(120);

// EXTERNAL MODULE: ./src/addons/generated/upstream-meta.json
var upstream_meta = __webpack_require__(197);
...
class settings_store_SettingsStore extends event_target["a" /* default */] {
  ...
  import(data) {
    for (const [addonId, value] of Object.entries(data.addons)) {
      if (!addon_manifests["a" /* default */].hasOwnProperty(addonId)) {
        continue;
      }
      const {
        enabled,
