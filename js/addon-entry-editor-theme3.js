...
var text_color_esm = __webpack_require__(1829);

// CONCATENATED MODULE: ./src/addons/addons/editor-theme3/theme3.js
...
/* harmony default export */ var theme3 = (async function (_ref) {
  let {
    addon,
    console
  } = _ref;
  ...
  const secondaryColor = category => {
    ...
    if (isColoredTextMode()) return Object(text_color_esm["a" /* alphaBlend */])(primaryColor(category), Object(text_color_esm["d" /* multiply */])(addon.settings.get(category.settingId), {
      a: 0.15
    }));
    if (textMode() === "black") return Object(text_color_esm["b" /* brighten */])(addon.settings.get(category.settingId), {
      r: 0.6,
      g: 0.6,
      b: 0.6
    });
    return Object(text_color_esm["d" /* multiply */])(addon.settings.get(category.settingId), {
      r: 0.9,
      g: 0.9,
      b: 0.9
    });
  ...
  const tertiaryColor = category => {
    ...
    if (textMode() === "black") return Object(text_color_esm["d" /* multiply */])(addon.settings.get(category.settingId), {
      r: 0.65,
      g: 0.65,
      b: 0.65
    });
  ...
  const fieldBackground = category => {
    ...
    if (category instanceof Blockly.Block || category instanceof Blockly.Field) {
      ...
      if (isColoredTextMode() || textMode() === "black") {
        ...
        if (isColoredTextMode()) return Object(text_color_esm["a" /* alphaBlend */])(primary, Object(text_color_esm["d" /* multiply */])(block.getColourTertiary(), {
          a: 0.25
        }));else return Object(text_color_esm["b" /* brighten */])(primary, {
          r: 0.4,
          g: 0.4,
          b: 0.4
        });
    ...
    if (textMode() === "black") return Object(text_color_esm["b" /* brighten */])(primaryColor(category), {
      r: 0.4,
      g: 0.4,
      b: 0.4
    });
  ...
  Blockly.FieldDropdown.prototype.init = function () {
    ...
    if (textColor(this) !== "#ffffff") this.arrow_.style.filter = Object(text_color_esm["f" /* recolorFilter */])(textColor(this));
  };
  ...
  Blockly.FieldDropdown.prototype.showEditor_ = function () {
    ...
    Blockly.DropDownDiv.DIV_.style.backgroundColor = Object(text_color_esm["g" /* removeAlpha */])(primaryColor);
    if (isColoredTextMode()) {
...
// EXTERNAL MODULE: ./node_modules/css-loader!./src/addons/addons/editor-theme3/theme3.css
var editor_theme3_theme3 = __webpack_require__(1910);
var theme3_default = /*#__PURE__*/__webpack_require__.n(editor_theme3_theme3);

// EXTERNAL MODULE: ./node_modules/css-loader!./src/addons/addons/editor-theme3/black_text.css
var black_text = __webpack_require__(1911);
var black_text_default = /*#__PURE__*/__webpack_require__.n(black_text);

// EXTERNAL MODULE: ./node_modules/css-loader!./src/addons/addons/editor-theme3/color_on_white.css
var color_on_white = __webpack_require__(1912);
var color_on_white_default = /*#__PURE__*/__webpack_require__.n(color_on_white);

// EXTERNAL MODULE: ./node_modules/css-loader!./src/addons/addons/editor-theme3/color_on_black.css
var color_on_black = __webpack_require__(1913);
var color_on_black_default = /*#__PURE__*/__webpack_require__.n(color_on_black);

// CONCATENATED MODULE: ./src/addons/addons/editor-theme3/_runtime_entry.js
...
const resources = {
  "theme3.js": theme3,
  "theme3.css": theme3_default.a,
  "black_text.css": black_text_default.a,
  "color_on_white.css": color_on_white_default.a,
  "color_on_black.css": color_on_black_default.a
};
