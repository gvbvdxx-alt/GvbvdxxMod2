...
// CONCATENATED MODULE: ./src/addons/addons/paint-snap/state.js
let snapOn = true;
...
// CONCATENATED MODULE: ./src/addons/addons/paint-snap/genSnapPoints.js
...
function createSnapPoints(paper, selectionBounds, lib, objects) {
  ...
  } : {}), snapTo.objectEdges ? Object.fromEntries(objects.filter(item => !(item.selected || item.data.isHelperItem)).map(item => [["item_".concat(item.id, "_r"), {
    type: "itemSideVert",
  ...
  }]]).flat(1)) : {}), snapTo.objectCenters ? Object.fromEntries(objects.filter(item => !item.selected).map(item => [["item_".concat(item.id, "_c"), {
    type: "point",
    value: item.bounds.center
  }]]).flat(1)) : {}), snapTo.objectMidlines ? Object.fromEntries(objects.filter(item => !item.selected).map(item => [["item_".concat(item.id, "_cx"), {
    type: "xcoord",
    value: item.bounds.center.x
  }], ["item_".concat(item.id, "_cy"), {
    type: "ycoord",
    value: item.bounds.center.y
  }]]).flat(1)) : {}), snapTo.objectCorners ? Object.fromEntries(objects.filter(item => !(item.selected || item.data.isHelperItem)).map(item => [["item_".concat(item.id, "_tl"), {
    type: "point",
...
// CONCATENATED MODULE: ./src/addons/addons/paint-snap/helpers.js
...
function helpers_defineProperty(obj, key, value) { key = helpers_toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
function helpers_toPropertyKey(arg) { var key = helpers_toPrimitive(arg, "string"); return typeof key === "symbol" ? key : String(key); }
function helpers_toPrimitive(input, hint) { if (typeof input !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (typeof res !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
...
// CONCATENATED MODULE: ./src/addons/addons/paint-snap/updateSelectTool.js
...
// CONCATENATED MODULE: ./src/addons/addons/paint-snap/ui.js
...
// CONCATENATED MODULE: ./src/addons/addons/paint-snap/genScalePoints.js
...
function genScalePoints_defineProperty(obj, key, value) { key = genScalePoints_toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
function genScalePoints_toPropertyKey(arg) { var key = genScalePoints_toPrimitive(arg, "string"); return typeof key === "symbol" ? key : String(key); }
function genScalePoints_toPrimitive(input, hint) { if (typeof input !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (typeof res !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
...
function createScalePoints(paper, lib, objects, sx, sy) {
  ...
  } : {}) : {}), snapTo.objectEdges ? Object.fromEntries(objects.filter(item => !(item.selected || item.data.isHelperItem)).map(item => [sx && ["item_".concat(item.id, "_r"), {
    type: "xcoord",
    value: item.bounds.right
  ...
  }]].filter(Boolean)).flat(1)) : {}), snapTo.objectMidlines ? Object.fromEntries(objects.filter(item => !(item.selected || item.data.isHelperItem)).map(item => [sx && ["item_".concat(item.id, "_cx"), {
    type: "xcoord",
    value: item.bounds.center.x
...
// CONCATENATED MODULE: ./src/addons/addons/paint-snap/updateScaleTool.js
...
// CONCATENATED MODULE: ./src/addons/addons/paint-snap/userscript.js
...
// EXTERNAL MODULE: ./node_modules/css-loader!./src/addons/addons/paint-snap/userstyle.css
var userstyle = __webpack_require__(1905);
var userstyle_default = /*#__PURE__*/__webpack_require__.n(userstyle);

// CONCATENATED MODULE: ./node_modules/url-loader/dist/cjs.js!./src/addons/addons/paint-snap/icons/decrement.svg
...
// CONCATENATED MODULE: ./node_modules/url-loader/dist/cjs.js!./src/addons/addons/paint-snap/icons/increment.svg
...
// CONCATENATED MODULE: ./node_modules/url-loader/dist/cjs.js!./src/addons/addons/paint-snap/icons/off.svg
...
// CONCATENATED MODULE: ./node_modules/url-loader/dist/cjs.js!./src/addons/addons/paint-snap/icons/on.svg
...
// CONCATENATED MODULE: ./node_modules/url-loader/dist/cjs.js!./src/addons/addons/paint-snap/icons/settings.svg
...
// CONCATENATED MODULE: ./node_modules/url-loader/dist/cjs.js!./src/addons/addons/paint-snap/icons/snap.svg
...
// CONCATENATED MODULE: ./src/addons/addons/paint-snap/_runtime_entry.js
